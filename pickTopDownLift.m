function grip_position = pickTopDownLift()
...
gripperTranslation = [-gripperY (gripperX + 0.1) (gripperZ - 0.2)];
...
grip_position = [gripperTranslation(1) gripperTranslation(2)... 
                 gripperTranslation(3) gripperRotation(1)... 
                 gripperRotation(2) gripperRotation(3)];
